...
**输出是一篇文章，不是几份报告拼接。** 原子在后台运行，读者看到的是一段连贯的认知旅程：先知道缺口在哪 → 再看清增量到底是什么 → 把关键概念用费曼技巧讲透 → 用一张餐巾纸速写看清新旧框架的位移 → 然后听一个带了二十年研究生的博导怎么评 → 最后判断这一步值不值得记住。
...
- 「博导审稿」自然过渡到「带走什么」：博导评完了，知道哪里实哪里虚，自然只带走站得住的部分。
...
- *零割裂感*：读完整篇分析，像一个人在跟你讲「我读了篇论文，让我告诉你它干了啥、好不好」。
